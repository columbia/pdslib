...
pub trait FilterStorage {
    ...
    fn new_filter(&mut self, filter_id: Self::FilterId, capacity: Self::Budget) -> Result<(), ()>;

    fn try_consume(&mut self, filter_id: Self::FilterId, budget: Self::Budget) -> Result<FilterResult, ()>;
